...
# Uses Singularity container to unzip.
...
then
    ...
    singularity run docker://crazymax/7zip 7za x json_2.1.0.7z -y && rm json_2.1.0.7z
...
then
    ...
    singularity run docker://crazymax/7zip 7za x json_feat_2.1.0.7z -y && rm json_feat_2.1.0.7z
...
then
    ...
    singularity run docker://crazymax/7zip 7za x full_2.1.0.7z -y && rm full_2.1.0.7z
